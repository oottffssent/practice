...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        var focusableElementsString = 'a[href], area[href], select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]';
